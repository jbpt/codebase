 ...
 */
public class TCTreeOLD<E extends IEdge<V>, V extends IVertex> extends AbstractTree<TCTreeNode<E,V>> {
	 ...
	 */
	public TCTreeOLD(IGraph<E,V> g, E edge) {
		if (g==null) return;
		this.graph = g;
		...
		if (isTrivialCase()) {
			...
			// decompose
			TCTree<E, V> decomposer = new TCTree<E, V>();
