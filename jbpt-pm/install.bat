...
call mvn install:install-file -Dfile=${project.basedir}/lib/jbpt-pm-relevance-1.1-SNAPSHOT-jar-with-dependencies.jar -DpomFile=${project.basedir}/lib/relevance-pom.xml
